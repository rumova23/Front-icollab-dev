		...
		this.subscriptions.push(this.eventService.onChangePage.subscribe({
			next: (event: EventMessage) => {
				...
				switch (event.descriptor) {
					case 'Security.SecurityDocComponent':
						this.viewContainerRef
							.createComponent(this.componentFactoryResolver.resolveComponentFactory(SecurityDocComponent))
							.changeDetectorRef
							.detectChanges();
						break;
					case 'Security.Usuarios':
