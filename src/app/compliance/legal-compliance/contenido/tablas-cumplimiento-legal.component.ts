...
import { DatosCumplimiento } from '../../models/datosCumplimiento';

@Component({
  selector: 'app-tablas-cumplimiento-legal',
  templateUrl: './tablas-cumplimiento-legal.component.html',
  styleUrls: ['./tablas-cumplimiento-legal.component.scss']
})
export class TablasCumplimientoLegalComponent implements OnInit {
