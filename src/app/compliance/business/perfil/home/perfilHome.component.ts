...
export class PerfilHomeComponent implements OnInit {
  ...
  private addFactoryPerfil() {
    const factoryPerfil = this.componentFactoryResolver.resolveComponentFactory(PerfilComponent);
  ...
  private addFactoryResponsabilities() {
    if (!this.isViewable) {
      return;
    }
    const factoryResponsabilities = this.componentFactoryResolver
      .resolveComponentFactory(ResponsibilitiesComponent);
    const refResponsabilities = this.perfil.createComponent(factoryResponsabilities);
    refResponsabilities.instance.inTipo = this.tipo;
    refResponsabilities.instance.inIdEmpleado = this.idEmpleado;
    refResponsabilities.changeDetectorRef.detectChanges();
  }
  ...
  private addFactoryBehavior() {
    ...
    const factoryBehavior = this.componentFactoryResolver
      .resolveComponentFactory(BehaviorComponent);
  ...
  private addFactorySkills() {
    ...
    const factorySkills = this.componentFactoryResolver
      .resolveComponentFactory(SkillsComponent);
  ...
  private addFactoryDashboards() {
    ...
    const factoryDashboards = this.componentFactoryResolver
      .resolveComponentFactory(DashboardsComponent);
  ...
  private addFactoryObsyComments() {
    ...
    const factoryObsyComments = this.componentFactoryResolver
      .resolveComponentFactory(ObsyCommentsComponent);
