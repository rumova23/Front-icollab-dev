...
@Component({
	selector: 'app-mat-table-billing',
	templateUrl: './mat-table-billing.component.html',
	styleUrls: ['./mat-table-billing.component.scss']
})
export class MatTableBillingComponent implements OnInit, OnChanges {
	...
	@Output() clickGenerateInvoice = new EventEmitter<any>();
	@Output() clickStamp = new EventEmitter<any>();
	...
	displayedColumnsActions: any[] = [
		...
		{ key: 'sys_generateInvoice' , label: 'sys_generateInvoice' },
		{ key: 'sys_stamp' , label: 'sys_stamp' },
		{ key: 'sys_cancel' , label: 'sys_cancel' }
	...
	onGenerateInvoice(e){
		this.clickGenerateInvoice.emit(e);
	}
	onStamp(e){
		this.clickStamp.emit(e);
	}
	onCancel(e){
		this.clickCancel.emit(e);
	}
