...
@Component({
  selector: 'app-mining-ifisalaryincrease-chart',
  templateUrl: './mining-ifisalaryincrease-chart.component.html',
  styleUrls: ['./mining-ifisalaryincrease-chart.component.scss']
})
export class MiningIFISalaryincreaseChartComponent implements OnInit {
