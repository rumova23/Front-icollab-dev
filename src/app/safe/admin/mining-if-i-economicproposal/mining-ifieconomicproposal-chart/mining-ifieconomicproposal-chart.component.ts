...
@Component({
	selector: 'app-mining-ifieconomicproposal-chart',
	templateUrl: './mining-ifieconomicproposal-chart.component.html',
	styleUrls: ['./mining-ifieconomicproposal-chart.component.scss']
})
export class MiningIFIEconomicproposalChartComponent implements OnInit {
