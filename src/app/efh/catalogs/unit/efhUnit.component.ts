...
@Component({
  selector: 'app-efh-unit',
  templateUrl: './efhUnit.component.html',
  styleUrls: ['./efhUnit.component.scss'],
  providers: [DatePipe]
})
export class EfhUnitComponent implements OnInit {

  public static mainCatalog = 'unit';
  ...
  action(option: number, id: any) {
    ...
    this.eventService.sendChangePage(new EventMessage(5 , type, 'Efh.Unidad.ABC'));
  }
  ...
  eliminarRegistro(maestroOpcion: any) {
    this.confirmationDialogService.confirm('Por favor, confirme..',
        ...
        .then((confirmed) => {
          if (confirmed) {
            this.catalogoMaestroService.outCatalogoItem(EfhUnitComponent.mainCatalog
