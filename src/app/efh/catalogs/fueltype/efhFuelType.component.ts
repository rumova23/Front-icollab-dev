...
@Component({
  selector: 'app-efh-fuel-type',
  templateUrl: './efhFuelType.component.html',
  styleUrls: ['./efhFuelType.component.scss'],
  providers: [DatePipe]
})
export class EfhFuelTypeComponent implements OnInit {

  public static mainCatalog = 'typeFuel';
  ...
  action(option: number, id: any) {
    ...
    this.eventService.sendChangePage(new EventMessage(5 , type, 'Efh.Tipo de combustible.ABC'));
  }
            ...
            this.catalogoMaestroService.outCatalogoItem(EfhFuelTypeComponent.mainCatalog
                ...
                data => {
                  ...
                  this.confirmationDialogService.confirm('Por favor, confirme..'
                      ...
                      .then((confirmed) => {
                            if (confirmed) {
                              this.catalogoMaestroService.outCatalogItemCloned(EfhFuelTypeComponent.mainCatalog
