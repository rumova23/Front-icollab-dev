...
lstTags['getCTUnoRT']             = {  calltags:'getCTUnoRT'              ,typadata:'int'    ,label: 'RT-1 - RT'             ,min:0  ,max:600  ,color:'#FF0000'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6IgGyUAAAU0VSVklET1JfUElcREFBMDgxMDY'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqg3gMAAAUElUVlxULkNFQS4yMjcx'      };
lstTags['getCTUnoMW']             = {  calltags:'getCTUnoMW'              ,typadata:'float'  ,label: 'RT-1 - MW'             ,min:0  ,max:600  ,color:'#FFA500'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6Igmh8AAAU0VSVklET1JfUElcRzFBMDgwMzA'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqgMgAAAAUElUVlw1MUNFQUdJMDAyXzAx'  };
lstTags['getCTUnoRPM']            = {  calltags:'getCTUnoRPM'             ,typadata:'int'    ,label: 'RT-1 - RPM'            ,min:0  ,max:600  ,color:'#FFC0CB'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6Ig3SIAAAU0VSVklET1JfUElcRzFBMDg0MDQ'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqgkQAAAAUElUVlw1MU1CSzAxQ1MwMDE'   };
lstTags['getCTDosGas']            = {  calltags:'getCTDosGas'             ,typadata:'int'    ,label: 'RT-2 - Gas'            ,min:0  ,max:600  ,color:'#008000'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6IgICAAAAU0VSVklET1JfUElcRzJBMDgwNzM'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqg9QAAAAUElUVlw1MkNFQUdGMDAxXzAx'  };
lstTags['getCTDosDiesel']         = {  calltags:'getCTDosDiesel'          ,typadata:'float'  ,label: 'RT-2 - Diesel'         ,min:0  ,max:600  ,color:'#FFFF00'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6IgLCAAAAU0VSVklET1JfUElcRzJBMDgwOTc'   ,id_EST:0   ,webId_EST:'ERROR'                                                     };
lstTags['getCTDosRT']             = {  calltags:'getCTDosRT'              ,typadata:'int'    ,label: 'RT-2 - RT'             ,min:0  ,max:600  ,color:'#0000FF'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6IgHCUAAAU0VSVklET1JfUElcREFBMDgxMDc'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqg3wMAAAUElUVlxULkNFQS4yMjcy'      };
lstTags['getCTDosMW']             = {  calltags:'getCTDosMW'              ,typadata:'float'  ,label: 'RT-2 - MW'             ,min:0  ,max:600  ,color:'#FFFFFF'  ,id_EAT:0  ,webId_EAT:'P0uQAgHoBd0ku7P3cWOJL6IgDSAAAAU0VSVklET1JfUElcRzJBMDgwNDY'   ,id_EST:0   ,webId_EST:'F1DP4rhZAwFMREKDf7s8vylUqglwAAAAUElUVlw1MkNFQUdJMDAyXzAx'  };
