...
@Component({
	selector: 'app-phase2v2',
	templateUrl: './phase2v2.component.html',
	styleUrls: ['./phase2v2.component.scss']
})
export class Phase2v2Component implements OnInit {
	...
	ngOnInit() {
		...
		this.LineChart = new Chart('lineChart21', {
			type: 'line',
		...
		this.LineChart = new Chart('lineChart31', {
			type: 'line',
